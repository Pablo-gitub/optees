...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("forecasting_validation", "Seasonal forecasting requires at least two complete seasons", "error_feedback.forecasting.seasons"),
        ("forecasting_validation", "Forecast holdout leaves insufficient training history", "error_feedback.forecasting.holdout"),
        ("forecasting_validation", "Forecast history contains a missing or off-frequency period", "error_feedback.forecasting.timestamps"),
