...
> **Archived:** this domain-neutral benchmark plan predates the dedicated
> Optees Decision Simulator roadmap. It is preserved for provenance but is not
> a current Optees implementation priority.
...
- [ ] the Workflow Registry and Experiment Ledger defined in the archived
  `docs/archive/superseded-plans/optimization-workflows-pre-case-study.md` plan.
