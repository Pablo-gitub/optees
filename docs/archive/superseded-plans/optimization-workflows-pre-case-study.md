...
> **Archived:** this pre-case-study plan combined generic workflow execution
> with experiment-ledger and adaptive-policy responsibilities. It is preserved
> for provenance but superseded by `docs/roadmaps/optimization-workflows.md`;
> Decision Simulator owns episode state, evaluation, policy comparison, and
> scoring.
...
protocol, and publication rules were specified separately in the archived
`docs/archive/superseded-plans/sequential-decision-benchmark-pre-simulator.md`
plan. The workflow platform supplies repeatability and provenance; the
benchmark harness owns simulation and scoring.
