...
class BoundedKnapsackSolution:
    """Domain result for a bounded knapsack solve."""
    ...
    def from_model_result(
        ...
        *,
        ...
        selected = tuple(index for index, quantity in enumerate(quantity_tuple) if quantity > 0)
        total_value = float(
        ...
        return BoundedKnapsackSolution(
            status=status_value,
